...
export const features = [
  {
    id: "feature-1",
    icon: "/urban-planning.png",
    title: "City Serenity",
    content:
      "Immerse yourself in a modern urban oasis that seamlessly blends contemporary living with tranquility. This property offers a serene escape amidst the hustle and bustle of the city, providing lush green spaces and a peaceful haven to call home.",
  },
  {
    id: "feature-2",
    icon: "/budget.png",
    ...
    content:
      "Prime location, strong market potential, and modern amenities for savvy investors.",
  },
  {
    id: "feature-3",
    icon: "/bungalow.png",
    ...
    content:
      "Waterfront luxury living with breathtaking views and upscale features.",
  },
];
...
export const propertyData1 = {
  ...
  location: "4BHK Banglow (Auction Property)",
  owner: "PS Groups",
...
export const propertyData2 = {
  ...
  location: "2 Storey house 4BHK ",
  owner: "AD Groups",
  places: "10 places nearby",
  price1: "₹45",
  amt: "Lakhs( Negotiable)",
  price2: "₹23,908",
  area1: "1,665",
  area2: "155",
  dimension1: "3",
  dimension2: "4",
  about: "Barasat indrolok  yogashram",
  number: "7980932387 ",
};

export const propertyData3 = {
  image: "/properties/Barasat2.jpg",
  location: "4BHK NEW HOUSE  ",
  owner: "AD Groups",
  places: "10 places nearby",
  price1: "₹68",
  amt: "Lakhs...",
  ...
  dimension1: "3",
  dimension2: "4",
  about: "Barasat Madhumurali",
  number: "7980932387",
};

export const propertyData4 = {
  image: "/properties/Barasat3.jpg",
  location: "4Bhk Full Furnished Smart Home ",
  owner: "AD Groups",
  places: "10 places nearby",
  price1: "₹1.4",
  amt: "Cr...",
  ...
  dimension1: "3",
  dimension2: "4",
  about: "Barasat Nabapally ",
  number: "7980932387",
};

export const propertyData5 = {
  image: "/properties/Barasat4.jpg",
  location: "2 BHK Independent House ",
  owner: "AD Groups",
  places: "10 places nearby",
  price1: "₹32",
  amt: "Lakhs...",
  price2: "₹23,908",
  area1: "3 Katha/ 1633.50",
  area2: "155",
  dimension1: "3",
  dimension2: "4",
  about: "Duttapukur ",
...
export const propertyData6 = {
  ...
  dimension1: "3",
  dimension2: "4",
  about: "Sarat ghosh garden road Kolkata. ( near DPS ruby park )",
  number: "89105 21377",
};
...
export const propertyData8 = {
  ...
  dimension1: "3",
  dimension2: "4",
  about: "Hridaypur jassor road ( near dakbamglow more )",
  number: "7980932387",
};
...
export const flatsData1 = {
  ...
  dimension1: "3",
  dimension2: "4",
  about: "The 3-bedroom + study apartment is available for rent in PS Groups.",
};

export const flatsData2 = {
  image: "/16.webp",
